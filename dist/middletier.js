...
/***/ "./src/middle-tier/Sharepoint-helper.ts":
/*!**********************************************!*\
  !*** ./src/middle-tier/Sharepoint-helper.ts ***!
  \**********************************************/
...
/* harmony export */   CreateRequestSP: () => (/* binding */ CreateRequestSP),
/* harmony export */   UpdateRequestSP: () => (/* binding */ UpdateRequestSP),
/* harmony export */   getSharepointData: () => (/* binding */ getSharepointData),
/* harmony export */   getSharepointDdoc: () => (/* binding */ getSharepointDdoc)
/* harmony export */ });
/* harmony import */ var node_sp_auth__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! node-sp-auth */ "node-sp-auth");
/* harmony import */ var node_sp_auth__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(node_sp_auth__WEBPACK_IMPORTED_MODULE_0__);
...
async function getSharepointData(req, res, next) {
  node_sp_auth__WEBPACK_IMPORTED_MODULE_0__.getAuth("https://vichitra.sharepoint.com/sites/dev/", {
    ...
    request_promise__WEBPACK_IMPORTED_MODULE_1__.get({
...
async function getSharepointDdoc(req, res, next) {
...
async function CreateRequestSP(req, next, res) {
  ...
  node_sp_auth__WEBPACK_IMPORTED_MODULE_0__.getAuth("https://vichitra.sharepoint.com/sites/dev/", {
    ...
    //perform request with any http-enabled library (request-promise in a sample below):
    let headers = options.headers;
    headers["Accept"] = "application/json;odata=nometadata", headers["Content-Type"] = "application/json", request_promise__WEBPACK_IMPORTED_MODULE_1__.post({
...
async function UpdateRequestSP(req, next, res) {
  let data = req.get("Data");
  ...
  node_sp_auth__WEBPACK_IMPORTED_MODULE_0__.getAuth("https://vichitra.sharepoint.com/sites/dev/", {
    ...
    //perform request with any http-enabled library (request-promise in a sample below):
    let headers = options.headers;
    headers["Accept"] = "application/json;odata=nometadata", headers["Content-Type"] = "application/json", headers["IF-MATCH"] = "*", headers["X-HTTP-Method"] = "MERGE", request_promise__WEBPACK_IMPORTED_MODULE_1__.post({
...
/* harmony export */   getSearchedUsers: () => (/* binding */ getSearchedUsers),
...
async function getUserData(req, res, next) {
  ...
  await (0,_ssoauth_helper__WEBPACK_IMPORTED_MODULE_1__.getAccessToken)(authorization).then(async graphTokenResponse => {
    if (graphTokenResponse && (graphTokenResponse.claims || graphTokenResponse.error)) {
      ...
      if (graphData.code) {
        next(http_errors__WEBPACK_IMPORTED_MODULE_2___default()(graphData.code, "Microsoft Graph error " + JSON.stringify(graphData)));
      } else {
        res.send(graphData);
      }
    }
...
async function getSearchedUsers(req, res, next) {
  const authorization = req.get("Authorization");
  ...
  await (0,_ssoauth_helper__WEBPACK_IMPORTED_MODULE_1__.getAccessToken)(authorization).then(async graphTokenResponse => {
    if (graphTokenResponse && (graphTokenResponse.claims || graphTokenResponse.error)) {
      ...
      const graphToken = graphTokenResponse.access_token;
      const graphUrlSegment = "/users?$select=displayName,id&$filter=startswith(displayName,'" + data + "')";
...
async function getAccessToken(authorization) {
  if (!authorization) {
    ...
    const tokenScopes = jsonwebtoken__WEBPACK_IMPORTED_MODULE_0___default().decode(assertion).scp.split(" ");
    ...
    const tokenResponse = await node_fetch__WEBPACK_IMPORTED_MODULE_2___default()(`${stsDomain}/${tenant}/${tokenURLSegment}`, {
      method: "POST",
      body: encodedForm,
      headers: {
        Accept: "application/json",
...
function validateJwt(req, res, next) {
  ...
  if (authHeader) {
    ...
    jsonwebtoken__WEBPACK_IMPORTED_MODULE_0___default().verify(token, getSigningKeys, validationOptions, err => {
      if (err) {
        console.log(err);
...
/***/ "node-sp-auth":
/*!*******************************!*\
  !*** external "node-sp-auth" ***!
  \*******************************/
/***/ ((module) => {

module.exports = require("node-sp-auth");
...
/* harmony import */ var _Sharepoint_helper__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./Sharepoint-helper */ "./src/middle-tier/Sharepoint-helper.ts");
/*
 * Copyright (c) Microsoft. All rights reserved. Licensed under the MIT license. See full license in root of repo. -->
 *
...
app.get("/getSearchedADUsers", _ssoauth_helper__WEBPACK_IMPORTED_MODULE_8__.validateJwt, _msgraph_helper__WEBPACK_IMPORTED_MODULE_7__.getSearchedUsers);
app.get("/getSPData", _ssoauth_helper__WEBPACK_IMPORTED_MODULE_8__.validateJwt, _Sharepoint_helper__WEBPACK_IMPORTED_MODULE_9__.getSharepointData);
app.get("/GetSPDoc", _ssoauth_helper__WEBPACK_IMPORTED_MODULE_8__.validateJwt, _Sharepoint_helper__WEBPACK_IMPORTED_MODULE_9__.getSharepointDdoc);
app.post("/CreateRequest", _ssoauth_helper__WEBPACK_IMPORTED_MODULE_8__.validateJwt, _Sharepoint_helper__WEBPACK_IMPORTED_MODULE_9__.CreateRequestSP);
app.post("/UpdateRequest", _ssoauth_helper__WEBPACK_IMPORTED_MODULE_8__.validateJwt, _Sharepoint_helper__WEBPACK_IMPORTED_MODULE_9__.UpdateRequestSP);
